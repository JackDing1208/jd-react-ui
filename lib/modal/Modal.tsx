      ...
      <Fragment>
        ...
        <div className={"jd-modal-dialog"}>
          <header className={"jd-modal-title"}>
            {props.title}
            <div/>
            <Icon name={"cross"} size={"1.2em"} className={"jd-modal-quit"} onClick={props.onClose}/>
          </header>
          <main className={"jd-modal-content"}>
            <div className={"jd-modal-content-text"}>
              <p>
                {props.content}
              </p>
            </div>
          ...
          <footer className={"jd-modal-buttons"}>
            {props.type !== "Alert" ?
              <Button onClick={onClickNo} style={{marginRight: "16px"}}>取消</Button>
              : null
            }
            <Button fill={"dark"}
                    onClick={(e) => {
